...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        long teenagers = persons.stream ().filter (person -> person.getAge () < 18).count ();

        // Список фамилий призывников (т.е. мужчин от 18 и до 27 лет)
        List<String> RecruitMan = persons.stream ().filter (person -> (person.getAge () >= 18 && person.getAge () <= 27))
        ...
        Collection<Person> ableBodied = persons.stream ().
                ...
                // с высшим образованием в выборке (т.е. людей с высшим  от 18 до 60 лет для женщин
